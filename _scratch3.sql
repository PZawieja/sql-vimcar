...
--       AND cc.outbound_id = 'K91789534' -- customer has multiple products, 2 of them will get a price increase on 16 April'22
      AND cc.outbound_id = '62622322' --  start date of 2017-06-20 for his first order (Vimcar Miet-Modell) and 2020-07-15 for all the other subscriptions which started in 2020.
